...
const socialConfig: Record<string, { label: string; path: string; viewBox?: string }> = {
  ...
  zalo: {
    label: "Zalo",
    path: "M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 17.08c-.292.146-.584.146-.73 0l-2.628-2.628c-.146-.146-.146-.438 0-.584l.584-.584c.146-.146.438-.146.584 0l2.044 2.044 2.044-2.044c.146-.146.438-.146.584 0l.584.584c.146.146.146.438 0 .584L17.894 17.08zM6.106 6.92c.292-.146.584-.146.73 0l2.628 2.628c.146.146.146.438 0 .584l-.584.584c-.146.146-.438.146-.584 0L6.252 8.672 4.208 10.716c-.146.146-.438.146-.584 0l-.584-.584c-.146-.146-.146-.438 0-.584L6.106 6.92z",
    viewBox: "0 0 24 24",
  },
};
